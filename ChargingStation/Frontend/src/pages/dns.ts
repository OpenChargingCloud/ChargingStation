 ...
 * inside the station that resolves anything - the name servers included, which
...
export const dnsPage: Page = {
    ...
    render({ root }) {
            ...
            render(content, html`
                ...
                <div class="cards stacked">
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            Switched off, this station asks nobody: the name servers are taken away from
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            ${mayTest
                                  ? html`
                                        This asks the way the station asks for anything: the servers above, in
                    ...
                    <section class="card">
                        ...
                        <p class="hint">Changing these means making another client, which means restarting the station.</p>
                    </section>
         ...
         * after twenty, because the station tries again. A deadline of ten
         * would have given up on a station that was still doing what it was
         * told.
         */
         ...
         *                null to ask the way the station asks for anything.
         */
            ...
            function paint(): void {
                ...
                render(dialog, html`
                    ...
                    <p class="hint">
                        ${asking === null
                              ? html`
                                    Asked the way this station asks for anything: the configured servers, in
