...
/**
 * How long after the stream has given up before the station is asked why.
 *
 * Measured: the station was stopped and started again, which takes every
 ...
 * frozen list for as long as it was left open, with the station up and running
 * and the operator signed out without being told.
 *
 * So when the browser gives up, the station is asked why. A 401 is the answer,
...
/**
 * And how long before asking again, where the station could not answer either.
 *
 * A pace that suits a page somebody has left open in front of a station that
...
export class LogStore {
    ...
    /** Set while the station is being asked why the stream stopped. */
    ...
    /**
     * Why the stream stopped, asked of the station rather than guessed.
     *
        ...
        this.askAgain = setTimeout(() => {
            ...
            api.auth.me().then(
                ...
                (problem: unknown) => {
                    ...
                    // The station could not answer either, so it is still
