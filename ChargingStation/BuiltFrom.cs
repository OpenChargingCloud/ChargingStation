...
namespace cloud.charging.open.ChargingStation
{
    ...
    /// <summary>
    /// One assembly this station is running, and the commit it was built from
    ...
    /// <summary>
    /// What this station was built from, read from the assemblies themselves.
    /// </summary>
    /// <remarks>
    ...
    public static class BuiltFrom
    {
        ...
        private static IReadOnlyList<LoadedAssembly> Collect()
        {
            ...
            // station does not reference and would otherwise be missing from
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var reference in assembly.GetReferencedAssemblies())
                {
                    ...
                    // depending on how the station was started.
                    try
                    {
