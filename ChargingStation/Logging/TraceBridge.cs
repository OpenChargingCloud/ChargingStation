...
namespace cloud.charging.open.ChargingStation.Logging
{
    ...
    /// <summary>
    /// Everything the libraries below this station write with Illias' DebugX,
    ...
    /// release build shows on the Logs page is what this station logs itself.
    ///
    ...
    public sealed class TraceBridge : TraceListener
    {
        ...
        /// tell what the station said itself from what it overheard.
        /// </summary>
