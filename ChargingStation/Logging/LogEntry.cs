...
namespace cloud.charging.open.ChargingStation.Logging
{
    ...
    public enum LogLevel
    {
        ...
        /// <summary>
        /// Something is not as it should be, but the station carries on.
        /// </summary>
        Warning,
    ...
    /// <summary>
    /// One thing that happened inside this charging station: when, how loudly,
    ...
    /// <param name="Tags">What it is about: "ocpp", "15118", "http", ... - lower case, without the level.</param>
