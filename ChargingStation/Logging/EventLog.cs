...
namespace cloud.charging.open.ChargingStation.Logging
{
    ...
    /// <summary>
    /// Everything that happens inside this charging station, in one place: the
    ...
    /// actually has in front of a charging station is "what happened just now",
    ...
    public sealed class EventLog
    {
        ...
        /// knows how. The station puts the same block here as on its console
        ...
        /// <summary>Something is not as it should be, but the station carries on.</summary>
