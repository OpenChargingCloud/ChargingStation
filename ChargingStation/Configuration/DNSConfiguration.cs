...
namespace cloud.charging.open.ChargingStation.Configuration
{
    ...
    /// <summary>
    /// The "dns" section of the configuration file: how this charging station
    /// resolves names.
    /// </summary>
    /// <remarks>
    /// Every field is optional, and null means "the file does not say" rather
    /// than "the file says nothing": what is missing keeps whatever the station
    /// was given at construction, and a station given nothing keeps the system
    ...
    /// </remarks>
    /// <param name="Enabled">Whether this station resolves names at all.</param>
                                          ...
                                          Byte?                           MaxRetries            = null)
    {
        ...
        /// <summary>
        /// The most name servers one station may be given. Not a rule of DNS -
        /// a query goes to all of them at once, and a hundred of them would be
        /// a hundred packets for every name this station ever looks up.
        /// </summary>
