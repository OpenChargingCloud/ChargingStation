...
namespace cloud.charging.open.ChargingStation.Configuration
{
    ...
    /// <param name="Servers">Every time server of this station, or none to ask only the one named by Hostname.</param>
                                          ...
                                          TimeSpan?                             MaxDeviation          = null)
    {
        ...
        /// <summary>
        /// The time servers this station asks when its configuration names none.
        /// </summary>
        /// <remarks>
        ...
        /// leave this station without a clock, and because two servers that agree
        ...
        /// <summary>
        /// The group a station asks when nothing has said otherwise.
        /// </summary>
        ...
        /// <summary>
        /// The time servers of this station as a group that can be asked.
        /// </summary>
        /// <remarks>
        /// Called "legal" after the white paper's well-known group, because
        /// this is the clock a charge is billed by. A station asking a second
