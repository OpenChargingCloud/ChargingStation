...
namespace cloud.charging.open.ChargingStation.Configuration
{
    ...
    /// <summary>
    /// The configuration of this charging station, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What a station is - how many outlets it has, what can be plugged into
    /// them, where it resolves names and reads the time - does not change
    ...
    public sealed class StationConfigFile
    {
        ...
        /// </summary>
        public StationConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out StationConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!StationConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: a station that only
                                                           ...
                                                           out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is a station nobody has
        ...
        /// rather than half of the new one. A charging station that cannot read
        ...
        /// now - and a file that stops the station is worse than a save that
        /// is refused.
        /// </remarks>
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this station runs on
