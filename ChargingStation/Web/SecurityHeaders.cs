...
namespace cloud.charging.open.ChargingStation.Web
{
    ...
    /// </summary>
    /// <remarks>
    /// The same shape as Hermod's own <c>SecurityHeaderOptions</c>, which the
    /// pinned Hermod of this repository does not have yet; when that submodule
    /// moves on, this file and <see cref="SecurityHeaderExtensions"/> can go
    /// and the using can point at Hermod instead.
    /// </remarks>
