...
namespace cloud.charging.open.ChargingStation
{
    ...
    /// </summary>
    /// <remarks>
    /// The pages of a charging station's own sections, that is: name
    /// resolution and the time are every node's, and are read and written
    /// by the <see cref="protocols.WWCP.Node.WWCPNode"/> below - by the same
    /// rules.
    ///
