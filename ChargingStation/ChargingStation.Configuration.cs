...
namespace cloud.charging.open.ChargingStation
{
    ...
    public partial class ChargingStation
    {
        ...
        /// "keyExchange" - which read as the station's time server and the
        ...
        public JObject NTSConfigurationJSON()
        {
            ...
            return new JObject(
                       ...
                       // it is in effect. The quorum is the one this station
                       ...
                       // checks this station's clock: each server's key
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // section the next start refuses, and a station that does not
        ...
        /// </summary>
        /// <remarks>
        /// The end of the chain this station built, not of the one the server
        ...
        /// servers in effect, which the section cannot know and this station
        /// does.
        /// </remarks>
                                          ...
                                          [NotNullWhen(false)] out String?  Error)
        {
                ...
                Configuration.Hostname   is null)
            {
                ...
                if (quorum > asked)
                {
                    Error = $"'nts.minServers' is {quorum}, which is more servers than the {asked} this station asks.";
                    return false;
                }
        ...
        private void ApplyNTSConfiguration(NTSConfiguration Configuration)
        {
            ...
            // is this group that decides whether the station may say it has
            // legal time.
            ...
            // The clock is checked on a timer set when the station started, so
